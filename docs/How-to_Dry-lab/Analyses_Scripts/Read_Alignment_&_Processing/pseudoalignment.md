...
- Method: It breaks reads into k-mers and maps them against a transcriptome de Bruijn graph to find the set of transcripts that match the read
- Tools: Primary tools utilizing this method include Kallisto, Salmon, and Sailfish. See [here](https://tinyheero.github.io/2015/09/02/pseudoalignments-kallisto.html) for a detailed description
